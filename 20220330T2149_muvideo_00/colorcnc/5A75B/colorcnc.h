...
//	hal_bit_t *index_en[NUM_chanal];
	hal_float_t *enccounts[encoders_count];
	hal_float_t encscale[encoders_count];
//	hal_float_t *encvel[NUM_chanal];
	...
	hal_bit_t stepgen_inverse_step[steppers_count];
	hal_bit_t stepgen_inverse_dir[steppers_count];
...
__u64 board_wallclock;
__u32 gpios_in;
__u32 encoder_position[encoders_count];
} pack_mainR_t;
